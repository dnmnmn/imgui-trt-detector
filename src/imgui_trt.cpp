...
bool ImGuiTRT::Initialize() {
    ...
    try
    {
        ...
        if (FileSystem::exist(CONFIG_PATH)) {
            ...
            throw std::runtime_error("ImGuiTRT::initialize() - Could not open config file");
        }
        ...
        if (!app->Initialize()) {
            ...
            throw std::runtime_error("ImGuiTRT::initialize() - App Error");
        }
        ...
        if (use_stream > 0) {
            ...
            if (!stream->Initialize()) {
                ...
                throw std::runtime_error("ImGuiTRT::initialize() - Stream Error");
            }
        ...
        if (use_detect) {
            ...
            if (!detect->Initialize()) {
                ...
                throw std::runtime_error("ImGuiTRT::initialize() - Detection Error");
            }
        ...
        if (use_tracker > 0) {
            ...
            if (!tracker->Initialize()) {
                ...
                throw std::runtime_error("ImGuiTRT::initialize() - Tracker Error");
            }
        ...
        if (use_segment) {
            ...
            if (!seg->Initialize()) {
                ...
                throw std::runtime_error("ImGuiTRT::initialize() - Segment Error");
            }
        ...
        if (use_filter > 0) {
            ...
            if (!filter->Initialize()) {
                ...
                throw std::runtime_error("ImGuiTRT::initialize() - Filter Error");
            }
        ...
        if (use_draw > 0) {
            ...
            if (!draw->Initialize()) {
                ...
                throw std::runtime_error("ImGuiTRT::initialize() - Draw Error");
            }
        ...
        // Catch exceptions
        DM::Logger::GetInstance().Log(e.what(), LOGLEVEL::ERROR);
    }
    catch (...) {
